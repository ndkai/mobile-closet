...
class CacheIntException extends GenericException {
  const CacheIntException([message])
      : super(message: AppStrings.cacheException + message);
}

class BadCertificateException extends GenericException {
  const BadCertificateException([message])
      : super(message: AppStrings.badCertificateException);
}
